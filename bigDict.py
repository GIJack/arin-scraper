...
ccLookupTable = {'Eritrea': 'ER', 'Bouvet Island': 'BV', 'Georgia': 'GE', 'Nicaragua': 'NI', 'Philippines': 'PH', 'Pitcairn': 'PN', 'Australia': 'AU', 'Antarctica': 'AQ', 'Finland': 'FI', 'Grenada': 'GD', 'United Arab Emirates': 'AE', 'Faroe Islands': 'FO', 'Monaco': 'MC', 'Niger': 'NE', 'Aland Islands': 'AX', 'Ecuador': 'EC', 'Tanzania, United Republic of': 'TZ', 'Spain': 'ES', 'Tonga': 'TO', 'Latvia': 'LV', 'Burkina Faso': 'BF', 'Brunei Darussalam': 'BN', 'Macao': 'MO', 'Israel': 'IL',
 'Panama': 'PA', 'Chile': 'CL', 'Puerto Rico': 'PR', 'South Sudan': 'SS', 'Central African Republic': 'CF', 'Taiwan, Province of China': 'TW', 'Hungary': 'HU', 'Aruba': 'AW', 'Liberia': 'LR', 'Bulgaria': 'BG', 'Romania': 'RO', 'Timor-Leste': 'TL', 'Madagascar': 'MG', 'Congo': 'CG', 'Dominican Republic': 'DO', 'Pakistan': 'PK', 'Samoa': 'WS', 'Anguilla': 'AI', 'Sweden': 'SE', 'Virgin Islands, British': 'VG', 'Serbia': 'RS', 'Indonesia': 'ID', 'Guernsey': 'GG', 'Morocco': 'MA', 'Mauritius': 'MU', 'Syrian Arab Republic': 'SY', 'Papua New Guinea': 'PG', 'United States': 'US', 'Japan': 'JP', 'Tokelau': 'TK', 'Northern Mariana Islands': 'MP', 'Equatorial Guinea': 'GQ', 'Barbados': 'BB', 'Togo': 'TG', 'Curaçao': 'CW', 'Lesotho': 'LS', 'Heard Island and McDonald Islands': 'HM', 'Cocos Keeling Islands': 'CC', 'Singapore': 'SG', 'Croatia': 'HR', 'Suriname': 'SR', 'French Polynesia': 'PF', 'Svalbard and Jan Mayen': 'SJ', 'Cayman Islands': 'KY', 'New Zealand': 'NZ', 'Chad': 'TD', 'Christmas Island': 'CX', 'Cuba': 'CU', 'Saint Pierre and Miquelon': 'PM', 'Jordan': 'JO', 'Greece': 'GR', 'Reunion': 'RE', 'Montenegro': 'ME', 'Holy See Vatican City State': 'VA', 'Saint Martin French part': 'MF', 'French Guiana': 'GF', 'Kazakhstan': 'KZ', 'Costa Rica': 'CR', 'Mali': 'ML', 'Guinea-Bissau': 'GW', 'Botswana': 'BW', 'Nigeria': 'NG', 'Swaziland': 'SZ', 'American Samoa': 'AS', 'Qatar': 'QA', 'Venezuela, Bolivarian Republic of': 'VE', 'Kuwait': 'KW', 'Sudan': 'SD', 'Martinique': 'MQ', 'Vanuatu': 'VU', 'Norfolk Island': 'NF', 'Turkey': 'TR', 'Sao Tome and Principe': 'ST', 'Lao Peoples Democratic Republic': 'LA', 'Wallis and Futuna': 'WF', 'Egypt': 'EG', 'Cook Islands': 'CK', 'Germany': 'DE', 
